/**
 * Space Invaders (太空侵略者) - 5 波闯关模式
 * @author ch2077
 * @version 2.0.1
 * @date 2025-04-12 重写为5波闯关，每波不同舰队配置
 * @date 2025-04-25 加了过关奖励生命机制，通关回满
 *
 * 经典街机射击，消灭所有外星舰队进入下一波
 * 外星人编队左右移动触边下移，随机向玩家射击
 * 5波难度递增：侦察→突击→精英→王牌→BOSS
 * 支持键盘方向键+鼠标移动+触屏拖动控制飞船
 */
const InvadersGame = {
